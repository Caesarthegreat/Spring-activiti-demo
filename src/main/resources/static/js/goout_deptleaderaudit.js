		    ...
		    "commands": function(column, row)
		    {
	    	    ...
	    	    grid.find(".command-run1").on("click", function(e)
	    	    {
	    	    	...
	    	    	$.post("dealtask_goout",{"taskid":taskid},function(data){
	    	    		...
	    	    		$("form").attr("action","task/deptcomplete_goout/"+taskid);
	    	    	});
	    	    	$("#dept").show();
	    	    	$("#btn").click(function(){
	    		    	$.post("task/deptcomplete_goout/"+taskid,$("form").serialize(),function(a){
	    		    		alert("处理成功");
	    		    		LoadAjaxContent("goout_deptleaderaudit");
	    		    	});
